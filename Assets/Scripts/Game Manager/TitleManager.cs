...
public class TitleManager : MonoBehaviour
{
	...
	public void DeleteSaveSlot(int saveSlotIndex)
	{
		...
		{
			Directory.Delete(SaveSystem.saveOneLocation + "/MainSave");
		...
		{
			Directory.Delete(SaveSystem.saveTwoLocation + "/MainSave");
		...
		{
			Directory.Delete(SaveSystem.saveThreeLocation + "/MainSave");
